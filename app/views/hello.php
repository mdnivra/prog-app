...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
              $.post("http://localhost/test/progknows/platform/public/index.php/accounts", 
                { network_id:23,access_token:'access_token',email:'email12',user_id: 1,network_type: "2pm" ,fullname:'asdasd'})
                  .done(function( data ) {
